...
conv1 = Conv2D(30, kernel_size=(2,2), activation='relu')(inputs)
pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)
conv2 = Conv2D(60, kernel_size=(2,2), activation='relu')(pool1)
pool2 = MaxPooling2D(pool_size=(2, 2))(conv2)
flat = Flatten()(pool2)
hidden1 = Dense(17, activation='relu')(flat)
output = Dense(10, activation='softmax')(flat)
model = Model(inputs=inputs, outputs=output)

#model = load_model('model_basic_43_32_64_15.h5')
# summarize layers
print(model.summary())
...
#model.save("model_basic_43_32_64_15.h5")
